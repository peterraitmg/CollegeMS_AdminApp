package com.project.admincollegeapp.image;
...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upoad_image);
        ...
        String[] items = new String[]{"Select Category","Tour","Bootcamp", "Teacher's Day" , "Farewell" ,"Other Events","User App Slider"};
